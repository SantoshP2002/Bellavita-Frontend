const QuizProducts = () => {
  return (
    <div className="dark:bg-black dark:text-white py-10">
      <h2 className="text-xl md:text-5xl text-center mb-4">
        Quiz LipStick Products
      </h2>

      {/* NEEDLE LINE */}
      <span className="mx-auto block h-[2px] w-[70%] bg-gradient-to-r from-transparent via-gray-400 to-transparent dark:via-gray-500 mb-4" />
