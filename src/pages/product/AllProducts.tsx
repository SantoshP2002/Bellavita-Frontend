...
import { CATEGORY_IMAGES, SORT_DATA } from "../../constants";
...
const AllProducts = () => {
  ...
  const currentCategory = queryParams.subCategory || queryParams.category;

  const categoryImage =
    currentCategory && CATEGORY_IMAGES[currentCategory.toLowerCase()];
