  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 dark:bg-black dark:text-white">
      <div className="mx-auto max-w-4xl px-4 py-8">
        {/* Header */}
        <h1 className="mb-6 text-3xl font-bold dark:text-white text-black">
          Shipping Policy
        </h1>

        <div className="py-10 shadow-md dark:shadow-white shadow-black">
          <p className="text-sm lg:text-xl m-5">
