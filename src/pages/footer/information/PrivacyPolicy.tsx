      ...
      <div className="mx-auto max-w-5xl px-4 py-8 dark:bg-black dark:text-white">
        ...
        <div className="space-y-6 rounded-lg bg-white p-6  dark:bg-black dark:text-white shadow-md dark:shadow-white shadow-black">
          ...
          <p className="text-xs lg:text-lg  leading-relaxed">
            ...
            with whom we may share the same. The Privacy Policy also describes
            the measures we take to protect the security of this information as
            well as how you can access, modify, or delete your personal
            information at any time. It also explains how you can object to the
          ...
          <Section title="Collection Of Personally Identifiable Information (PII) And Other Information">
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              refund. Examples of customer information that may be collected by
              us include your name, address, telephone number, date of birth,
              email address, descriptions of the items requested or purchased,
          ...
          <Section title="Registration">
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              any reason, you should change it immediately.
            </p>
          </Section>
          ...
          <Section title="Technologies That Allow Us To Customise Your Experience On Bella Vita Organic">
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              whether you have visited Bella Vita Organic before. They also may
              enable you to save your preferences. Each technology is explained
              below.
            </p>
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              combination with Cookies and are often not visible to the user of
              the website. Web Beacons may relay information to third parties
              such as our service providers and may be used in order to track
              customer response to certain advertising, to better target
              interactive advertising, and to enhance customer support and
              usability. If you reject our Cookies (see the Cookie section
              below), you will prevent Web Beacons from relaying this
              information about you and may limit your use of some of our
              website features.
            </p>
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              certain features on the website and you may be required to reenter
          ...
          <Section title="How Do We Mutually Benefit From The Personal Information?">
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              <p className="text-xs lg:text-lg  leading-relaxed">
                ...
                phone. Please note that we will never send you any unsolicited
                text message on your mobile phone. Bella Vita Organic does not
                charge any fee for you to receive any text message from us.
                However, your mobile service provider may charge you for sending
                and/or receiving text messages and air-time, as well as any
                other standard applicable rates charged by your mobile service
                provider.
              </p>
              ...
              <p className="text-xs lg:text-lg  leading-relaxed">
                ...
                your mobile phone or landline phone.
              </p>
              <p className="text-xl my-5 leading-relaxed">
              ...
              <p className="text-xs lg:text-lg  leading-relaxed">
                ...
                contact you regarding your customer service requests or
                questions. For example, all registered users will receive a
                welcoming email to confirm their registration. These types of
                communications are necessary to serve you, respond to your
                concerns and to provide a high level of customer service that
          ...
          <Section title="Sharing Of Personal Information">
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              companies, courier companies, data analysis firms, customer
              support specialists, email vendors, web-hosting companies and
              fulfilment companies (e.g., companies that coordinate mailings).
              Such third parties may be provided with access to personal
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              share your information with such third party and the information
          ...
          <Section title="Transfer Of Data To Other Countries">
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              stored shall be located in India and are required to honour the
              privacy representations made in this Privacy Policy under
              applicable laws of this country. In case of transfer of data to
              any other country, legal protections applicable to personal
              information in the concerned country will apply.
            </p>
          </Section>
          ...
          <Section title="Policy Change">
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              privacy policy changes). We will also keep prior versions of this
          ...
          <Section title="OUR RIGHTS">
            ...
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              portal. We may terminate your access, or suspend your access to
              all or part of the Site, without notice, for any conduct that we,
              in our sole discretion, believe is in violation of any applicable
              law or is harmful to the interests of another user, a third-party
              Provider, Merchant, Sponsor, Licensor, service provider, or us.
              Because customer service is paramount to our business, we reserve
              the right to refuse to sell products to you if it reasonably
              appears to us that you intend to resell the products. In addition,
              we reserve the right to limit quantities of items purchased by
              each customer.
            </p>
          </Section>
          ...
          <Section title="Children">
            <p className="text-xs lg:text-lg  leading-relaxed">
              ...
              are under 18 years of age, you may browse Bella Vita Organic, but
              please do not provide your personal information to us. For
              example, you cannot register. If we become aware that we have
              inadvertently received personal information from a visitor under
              the age of 18 on the website, we will delete the information from
              our records.
            </p>
          </Section>
          ...
          <Section title="Use of Personal Information">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>To prevent fraud and enforce policies</li>
